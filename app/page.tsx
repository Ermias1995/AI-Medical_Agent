  ...
  return (
    <div className="relative my-10 flex flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          Deliver instant, accurate, and personalized healthcare solutions with our AI-powered voice agents. Enhance patient engagement and streamline communication like never before.
          Automate appointments, answer queries, and provide 24/7 support with ease.
